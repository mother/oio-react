export default [{
   ...
   type: 'String (Enum)',
   default: '-',
   description: 'This value can be one of: <code>outline</code> or <code>plain</code>. <br /><br />By default, the appearance of the component is set through the value of the nearest <code>Form</code>\'s <code>elementAppearance</code> prop. If the <code>appearance</code> prop is set on this component, it will take precedence over the <code>appearance</code> value provided by the <code>Form</code>.',
   responsive: false
}, {
   name: 'highlightColor',
   type: 'String',
